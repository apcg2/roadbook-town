...
- `sources`：私有记录，含id、provider、url、fetchedAt、accepted、筛选说明；口碑来源还需匿名authorRef及evidenceType（post/comment）。小红书来源provider=redfox且accepted=true才能支持口碑。不要把原文、账号或凭据放到生成HTML。
